...
{   
  ...
  //cam.setImageSize(VC0706_320x240);       // small
  ...
  if (!myFile.open("foto.jpg", O_RDWR | O_CREAT ))
  {
    //sd.errorHalt("opening file image");
    return false;
  }
  // Open the file for writing
  //myFile.open(filename, O_RDWR | O_CREAT );
...
void loop() 
{
  ...
  if (gps) {     
    ...
    // Magic Line: You have to wait 3seconds before shot picture.
    // If you don't wait, the result is a picture with a wrong exposition
    delay(3000);  
